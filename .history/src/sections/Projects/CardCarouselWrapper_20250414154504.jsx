...
function CardCarouselWrapper() {
  const cardsContainer = document.querySelector(".cardCarouselWrapper");
  const cardsController = document.querySelector(".cardCarouselWrapper + .card-controller")
  ...
  const carousel = new CardCarouselWrapper(cardsContainer)
  
  return (
  <div>
  <div class="container">
  <div class="cardCarouselWrapper">
    <div class="card" id="1">
