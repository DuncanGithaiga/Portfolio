...
function Skills() {
  ...
  return (
    ...
    <div className={styles.column}></div>
      ...
      <div className={styles.column}>
        <img src="../../assets/laravel.svg" alt="laravel" style="width:100%"/>
      </div>
      <div className={styles.column}>
        <img src="../../assets/flutter.svg" alt="flutter" style="width:100%"/>
      </div>
      <div className={styles.column}>
        <img src="../../assets/react.svg" alt="react" style="width:100%/"/>
      </div>
    </div>
    </div>  
    <hr />
