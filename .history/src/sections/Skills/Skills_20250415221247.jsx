...
function Skills() {
  ...
  <div className={styles.row}>
    <div className={styles.column}>
      <img src="/assets/laravel-framework.png" alt="Laravel" loading="lazy" />
    </div>
    <div className={styles.column}>
      <img src="/assets/dart-programming.png" alt="Flutter" loading="lazy" />
    </div>
    <div className={styles.column}>
      <img src="/assets/python-language.png" alt="Python" loading="lazy" />
    </div>
    <div className={styles.column}>
      <img src="/assets/react.png" alt="React" loading="lazy" />
    </div>
  </div>
</div>
    </div> 
