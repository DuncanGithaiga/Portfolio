  ...
  return (
    ...
    <div className={styles.columns}>
      ...
      <div className={styles.column}>
        <Spline scene="https://prod.spline.design/CxwxR9FVX5uNjEMb/scene.splinecode" loading="lazy"/>
      </div>
      ...
      <div className={styles.column}>
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          transition={{ delay: index * 0.1, duration: 0.5, ease: 'easeOut',type: 'spring',
            stiffness: 500,
            damping: 20,
            delay: index * 0.1, }}
        >
        ...
        <div className={styles.logosText}>
          ...
          <p>These are the tools and technologies I use to create amazing applications.</p>
        </div>
        <div className={styles.logosText}>
          <h2>Frameworks</h2>
          <p>These are the frameworks I use to create amazing applications.</p>
      </div>
      </div>
    </div>
  </section>
