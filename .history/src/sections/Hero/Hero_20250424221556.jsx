...
function Hero() {
    ...
    const [bgIndex, setBgIndex] = useState(0);
      ...
      const backgrounds = [gradient, particles, way];
    ...
    <section id="hero"  className={styles.container}>
        ...
        {backgrounds.map((bg, i) => (
              <React.Fragment key={i}>
                {/* Blurred Layer */}
                <div
                  className={styles.bgLayerBlur}
                  style={{
                    backgroundImage: `url(${bg})`,
                    opacity: i === bgIndex ? 1 : 0,
                  }}
                />
                {/* Sharp Transparent Layer */}
                <div
                  className={styles.bgLayerSharp}
                  style={{
                    backgroundImage: `url(${bg})`,
                    opacity: i === bgIndex ? 0.4 : 0, // adjust for cinematic layering
                  }}
                />
              </React.Fragment>
            ))}
